...
- run build
- run viewer
- navigate to [Exercise 1](bblocks://ogc.bbr.tutorial.exercise1)
- navigate to [Examples](bblocks://ogc.bbr.tutorial.exercise1/examples) tab
...
* YAML version: [schema.yaml](https://canocnig.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise1/schema.json)
* JSON version: [schema.json](https://canocnig.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise1/schema.yaml)
